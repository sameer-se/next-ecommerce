                    ...
                    <nav className="flex justify-between p-4">
                        <div>
                            <ul className="list-none md:flex gap-10 ">
                                ...
                                <li>  <a href="tel: 9803378205"> <BiPhoneCall className="inline"/> 9803378205</a></li>
                            </ul>
                        </div>
                        <div className="flex gap-6 items-center"> 
                            ...
                            <ul className="inline md:flex gap-4">
                                <li><a>Login <BsPerson className="inline"/></a> </li>
                                <li><button>Wishlist <AiOutlineHeart className="inline"/></button></li>
                            </ul>
                            <div className="hidden md:flex list-none">
                                <li><button><FiShoppingCart/></button></li>
                            </div>
                        </div>
                    </nav>
                </div>
